...
Route::get( '/geonames/{countryCode}/{region}', '\MichaelDrennen\Geonames\Controllers\GeonamesController@regionByCountry' )->name('api.geonames.region_by_country');

Route::get( '/geonames/{countryCode}/{region}/{city}', '\MichaelDrennen\Geonames\Controllers\GeonamesController@cityByRegionAndCountry' )->name('api.geonames.city_by_region_and_country');
/**
